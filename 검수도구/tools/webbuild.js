...
/* (v399) 0027(에셋 패널)·0031(v33)·0033(v34)·0039(v4.0) 추가 — 본체(0023)가 없어 150ms 마다 영원히 재시도만 하던 에디터 부속.
   0025(에셋 저장소)는 런타임 필수, 0029/0035 는 renderMap 패치 체인이라 확인 전까지 둔다. */
const STRIP = new Set(['0023','0027','0031','0033','0036','0037','0038','0039','0040','0041','0042','0043','0044','0045',
