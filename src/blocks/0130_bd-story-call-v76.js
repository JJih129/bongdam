...
(function(){
  ...
  var SCENE = {
    ...
    ch3: { done:'동화리', caller:'재현', next:'수영리',
           friend:'은지 어머니', friendRef:'은지네 어머니', honor:true, trouble:'가로등이 꺼진 밤길 때문에 은지 데리러 다니기가 무섭다고' }   /* (v399e) 어두운 골목은 준호의 부탁 — 은지 어머니 실제 부탁(가로등)과 일치 */,   /* (v399) «내 친구 은지 어머니» → «은지네 어머니가 … 하시더라고» */
