...
/* ══════════════════════════════════════════════════════════════════
   (v239) 담이 튜토리얼 시스템
   ------------------------------------------------------------------
   · BD_DAMI  : 봉담 활동 배지 '담이' 대화창 (기존 bd-tutorial 배너 전용)
...
(function () {
  ...
  /* ══════════════ (v239) 새 스킬 첫 전투 튜토리얼 ══════════════
     ...
     을 수행한 뒤 예약이 해제된다. */
  var SKILL_INTRO = {
    /* (v399) 획득 팁(SKILL_TIPS)과 같은 문장이었다 — 전투 첫 턴에는 «떠올리기» 톤으로 변주 */
    fan:   ['노트 부채질', '🌀', '아까 배운 대로! 1.2초 동안 최대한 빠르게 연타예요'],
    wash:  ['물청소 정화', '💦', '기억나죠? 물줄기를 얼룩에 계속 대고 있기 — 누르면 위, 떼면 아래'],
    light: ['안전 점검 라이트', '🔦', '빛이 적 주위를 돌아요. 좌우 키로 각도만 맞춰 주세요'],
    cheer: ['힘내라 봉담!', '📣', '「봉! 담! 화이팅!」 세 박자, 셋 다 맞추면 특별해요'],
  };
