...
(function(){
  ...
  var NEW_NPCS = [
    ...
    { sid:213, id:'bdnpc_jaei',    asset:'npc_front_jaei',    name:'재이', x:0.098, y:0.495, rh:0.0448, hzTarget:'ow213_glass_1',   /* (v400 1c) 유리를 공원 위쪽으로 옮기자 거리 그리디가 사서 도현에게 넘겼다 → 짝 고정 */   /* (v399) 212→213: 에디터 배치(9/06) 위치. 212 는 0143 툼스톤 */
