...
| `PC웹_개선제안_v399.md` | PC(마우스·키보드) 감사 결과·구현 상태 |
| `스토리_시나리오_개선안_v399.md` | 스토리·대사·교육 메시지 전수 분석과 리라이트·스크립트 테이블 제안 |
...
- PC 조작(v399): WASD/방향키 이동 · F 조사·대화 · Space 대화 · E 가방 · J 임무 · M 안전지도 · Esc 창 닫기/일시정지 · Shift+F 전체화면 · 마우스는 대상 클릭=F, 빈 곳 클릭=걸어가기
